package org.dipen.exactlyOnceProcessing;
 ...
 * Custom consumer that reads only specified partation and implements single atomic processing
 *
 * Import the sql file in resource folder and run the code
 */
